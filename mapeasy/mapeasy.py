...
class Map(ipyleaflet.Map):
    ...
    def add_fullscreen_control(self, position='topleft'):
        ...
        Args:
            ...
            position (str, optional): Position of the fullscreen icon. Defaults to "topleft".
        """        
    ...
    def add_local_raster(self, filename, name='Local raster', **kwargs):
        ...
        try:
            ...
            raise ImportError("localtileserver not installed. Please install it with 'pip install'")
